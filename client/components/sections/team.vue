          ...
          <v-row class="section__content">
            <v-col cols="7">
              <p class="section__text">
                Обратившись в нашу компанию, Вам не придется его тратить. Вам не
                нужно дополнительно искать специалистов по рекламе и
                продвижению. Всю работу мы берем на себя. Мы работаем под ключ.
              </p>
              ...
              <v-row class="section__about">
                <v-col cols="6">
                  ...
                  <h6 class="section__description section__description--second">
